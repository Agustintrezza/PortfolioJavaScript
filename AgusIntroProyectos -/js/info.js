...
document.getElementById('cv').classList.add('borderdark');
...
document.getElementById('cv').classList.remove('borderdark');
}
...
const cvBorderDark = document.getElementById('linkedin');
cvBorderDark.classList.toggle('borderdark');

const cvBorderDark2 = document.getElementById('cv');
cvBorderDark2.classList.toggle('borderdark');
...
const logosBtn = document.querySelector('.fab')
...
// const navitem1 = document.querySelector('.navitemdos');
// navitem1.classList.toggle('hambdark');
...
if(localStorage.getItem('fondoreproductor') === 'true') {
  document.getElementById('audio').classList.add('audiodark')
  document.getElementById('audio').classList.add('hambdark')
  document.getElementById('audio').classList.remove('audiolight')
} else {
  document.getElementById('audio').classList.remove('audiodark')
  document.getElementById('audio').classList.add('audiolight')
...
// TITULO CURSOS
// if (document.queyselectorcontains('titulocolor')) {
//   localStorage.setItem('titulocolor', 'true');
// } else {
//   localStorage.setItem('titulocolor', 'false');
// }
...
//   if(localStorage.getItem('footeractivo') === 'true') {
//     document.getElementById("footeractivo").innerHTML = "X OCULTAR";
//   }
// }

  
// // HOVER JAVASCRIPT TITULO

document.getElementById("cv1").onmouseover = function() 
{
    console.log('agus');
    document.getElementById('cv').style.opacity = ".9";
    // this.style.backgroundColor = "blue";
}
document.getElementById("cv1").onmouseout = function() 
{
    console.log('agus');
    document.getElementById('cv').style.opacity = "1.2";
    // this.style.backgroundColor = "blue";
}
...
function abrirCv() {
  ...
  // ABRIR CERTIFICADOS 
  function abrirCertificado1() {
    window.open('/assets/img/certificadoReact.pdf', '_blank');
  }
  function abrirCertificado2() {
    window.open('/assets/img/certjsmoderno.pdf', '_blank');
  }
  function abrirCertificado3() {
    window.open('/assets/img/cssgridflex.pdf', '_blank');
  }
  function abrirCertificado4() {
    window.open('/assets/img/webcompleto1.pdf', '_blank');
  }
  function abrirCertificado5() {
    window.open('/assets/img/webcompleto2.pdf', '_blank');
  }
  function abrirCertificado6() {
    window.open('/assets/img/certwordpress.pdf', '_blank');
  }
  function abrirCertificado7() {
